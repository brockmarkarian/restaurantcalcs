---
title: "How Much Does DoorDash Actually Take From Restaurants?"
description: "What DoorDash, Uber Eats, and Grubhub really take per order, the fees the commission rate hides, and when delivery still makes money. From a 5-year GM."
pubDate: 2026-06-17
author: "Brock"
tags: ["Delivery", "Third-party", "Margin", "Operations"]
...
The [third-party delivery calculator](/calculators/delivery-profit/) on this site runs your real take-home after commission, processing, and packaging, so you can see what an order actually nets at 15%, 25%, or 30%. Run your top delivery items through it. Some will clear it fine and a few will be selling at a loss, and you want to know which is which before you build a delivery-only menu. The broader cost picture is in [what third-party delivery actually costs you](/blog/third-party-delivery-real-cost/).
...
Sources: [DoorDash for Merchants](https://merchant.doordash.com/), [Uber Eats](https://merchants.ubereats.com/), [National Restaurant Association](https://restaurant.org/), [Toast](https://pos.toasttab.com/).
