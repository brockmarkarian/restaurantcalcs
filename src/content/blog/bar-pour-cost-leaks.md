...
heroImage: "/illustrations/blog-bar-pour-cost.webp"
---

I poured 1.7 ounces when I started behind the bar. I called it 1.5. I'd watched a YouTube video about cocktail technique and the guy on it free-poured everything, so naturally I free-poured everything. The senior bartender caught me at the end of my second shift, handed me a jigger, and said "this is one and a half ounces. Yours wasn't."

He wasn't mean about it. He just held up the jigger like it was a remedial reading book. I don't think I've ever felt smaller in a hospitality job.
...
This is the slowest leak and the hardest to spot. Your menu prints a 1.5 oz pour on the vodka soda. Your bartenders pour 1.75 because they were trained by the senior bartender who learned from a bartender who learned from someone who liked a heavy hand. The lineage of bar training is mostly oral, mostly informal, and mostly drift.
...
1. Comp records — are buybacks and staff meals being rung?
2. Recipe specs — pour every drink, measure the output
3. Receiving — open the next three spirits deliveries at the door
4. Inventory count — recount by category, check for math errors
5. Pour discipline — measured spouts in use? Are new hires trained on spec?
6. *Then* consider theft — and even then, it's usually a single problem employee, not a systemic issue

Theft is the diagnosis you arrive at last, not first.

## Aggregate vs per-drink: read both numbers

The pour cost percentage you compute over a week or month — total beverage cost divided by total beverage revenue — is your aggregate number. Industry-healthy ranges:
...
Also, if you're a new bartender and the senior bartender just held up a jigger at you: that's not a punishment. It's the cheapest variance fix you'll ever get.
